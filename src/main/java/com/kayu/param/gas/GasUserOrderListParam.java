...
import com.kayu.result.gas.GasUserOrderListResult;
 ...
 */
@Data
public class GasUserOrderListParam implements IBaseParam<GasUserOrderListResult> {
    ...
    public String requestURI() {
        return "/api/v1/gas-order/queryUserOrderList";
    }
    ...
    @Override
    public Class<GasUserOrderListResult> resClass() {
        return GasUserOrderListResult.class;
